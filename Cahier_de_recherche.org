...
*** TODO :: Find a way to save in my local environnement the trainning datas generated in environnement of the node
...
** TODO :: Comparaison GA Deep search
+ 10 tuples
+ 2*10 curves ( Ga, DS )
...
*** TODO :: Paralellize the computation of each tuples for the two experimental contexts (DS,GA)
*** TODO :: Do the same thing with a budget of 1 hour for each context and compare them
* Lundi 11 mars
** Paralellize the computation by tuple
*** DONE :: Use the arg for the seed
*** TODO :: Finding a way to parallelize the computation
...
#+end_example
** TODO :: Problem, the gnome-terminal instruction is not installed
