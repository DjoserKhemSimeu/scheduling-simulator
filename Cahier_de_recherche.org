...
*** TODO ::Representation in two dimension of the intial distribution of the pop in the two methods
...
*** TODO :: Graph with 10 time the same tuples in the two configuration with different seed to ensure reproductibility
